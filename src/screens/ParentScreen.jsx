      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.addCard}>
          <View style={styles.cardHeader}>
            <View>
              ...
              <Text style={styles.cardSubtitle}>Create a new child account</Text>
            </View>
            <TouchableOpacity
        ...
        <ScrollView horizontal showsHorizontalScrollIndicator={false} style={styles.filterRow}>
          <TouchableOpacity
            ...
            style={[styles.filterButton, filterStatus === null && styles.filterActive]}
          >
          ...
          {statuses.map((status) => (
            <TouchableOpacity
              ...
              style={[styles.filterButton, filterStatus === status && styles.filterActive]}
            >
        ...
        {filteredChildren.length === 0 ? (
          <View style={styles.emptyState}>
            ...
            <Text style={styles.emptySubtitle}>Try adding or changing filters</Text>
          </View>
        ) : (
          <>
            <View style={styles.childrenHeader}>
              <Text style={styles.childrenTitle}>Child Progress</Text>
              <Text style={styles.childrenCount}>{filteredChildren.length}</Text>
            </View>
      ...
      >
        <View style={styles.modalOverlay}>
          <View style={styles.modalBox}>
            ...
            {newChildImage ? (
              <Image source={{ uri: newChildImage }} style={styles.modalImage} />
            ) : (
            ...
            <TouchableOpacity onPress={addChild} style={styles.modalAddButton}>
